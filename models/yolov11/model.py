...
from yolohub.utils.general import make_anchors, compute_iou

from yolohub.models.base_model import BaseModel

# Functions and classes adapted from original nn.py file:
...
class DFL(nn.Module):
    def __init__(self, ch=16):
        super().__init__()
        self.ch = ch
        self.conv = nn.Conv2d(ch, out_channels=1, kernel_size=1, bias=False).requires_grad_(False)
...
class Head(nn.Module):
    ...
    def __init__(self, nc=80, filters=()):
        ...
        self.box = nn.ModuleList(nn.Sequential(
